...
public class Number_of_student2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_number_of_student2);
    }
    ...
    public void ref(View view) {
       ...
       Double number = Double.parseDouble(e1.getText().toString());
        ...
        TextView k6 = (TextView) findViewById(R.id.textView23);
        ...
        TextView t7 = (TextView) findViewById(R.id.textView24);
        double dm = 0.020;
        double da = 2.40;
        double hsm = 0.025;
        double hsa = 0.25;
        ...
        double sabzim = hsm * number;
        double sabzia = hsa * number;
        ...
        double jalawana = ja * number;
            ...
            k6.setText(String.format(" %.2f", aalum));
            t7.setText(String.format(" %.2f", aalua));
